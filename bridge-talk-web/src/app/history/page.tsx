  ...
  return (
    <div className="p-4 border rounded shadow w-full max-w-md">
      <div className="flex justify-between mb-4">
        <h2 className="text-xl font-bold">輸入心聲</h2>
        {userEmail ? (
          <button onClick={handleLogout} className="text-sm text-red-600">登出</button>
        ) : (
          <button onClick={() => router.push('/login')} className="text-sm text-blue-600">登入</button>
        )}
      </div>
