...
exports.thirdPersonReply = void 0;
const buildReplyPrompt_1 = require("../utils/buildReplyPrompt");
const trackTokenUsage_1 = require("../utils/trackTokenUsage");
const supabaseAdmin_1 = require("../lib/supabaseAdmin");
const OPENAI_API_KEY = process.env.OPENAI_API_KEY || '';
const OPENAI_API_URL = 'https://api.openai.com/v1/chat/completions';
const thirdPersonReply = async (req, res, next) => {
    ...
    let messages;
    try {
        messages = (0, buildReplyPrompt_1.buildReplyPrompt)({ message: userInput, role, tone });
    }
    catch {
...
exports.thirdPersonReply = thirdPersonReply;
